...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnCript.addEventListener('click', async () => {
        try {
            ...
            alert('Texto criptografado e adicionado ao historico com sucesso!');
        } catch (err) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnDescript.addEventListener('click',() => {
        ...
        addSearchToHistory(document.getElementById("entrada").value);
        addSearchToHistory(document.getElementById("texto-resultado").innerHTML);
        alert('Texto descriptografado e adicionado ao historico com sucesso!');
    });
});
...
function openHistory() {
    ...
    const logoCat = document.getElementById('img-logo');
...
function closeHistory() {
    ...
    if (btnOpen && historyContainer) {
        btnOpen.style.display = "block";
        historyContainer.style.display = "none";
        btnClose.style.display = "none";
        logoCat.style.display = "block";
    }
}